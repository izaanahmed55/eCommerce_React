const CheckOut = () => {
  ...
  <a href="#" className="text-2xl font-bold text-gray-800">Place your Order</a>
...
<div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  <div className="px-4 pt-8">
    ...
    {itemsArray?.map((itemsArray) => {
        ...
        return <>
            <div key={id} className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
        <div className="flex flex-col rounded-lg bg-white sm:flex-row">
        <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={thumbnail} alt="" />
