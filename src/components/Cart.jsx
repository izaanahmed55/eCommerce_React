    ...
    if (itemsArray?.length > 0) {
        ...
        return (
            <>
                <div className="h-screen p-5">
                    ...
                    <div className="">
                        <div className="rounded-lg md:flex lg:flex justify-between">
                            <div className="w-3/4 p-5">
                                ...
                                <button
                                    onClick={() => emptyCart()}
                                    className="mt-6 place-content-center w-1/2 rounded-md bg-red-500 py-1.5 font-medium text-red-50 hover:bg-red-600"
                                >
                                    Clear Cart
                                </button>
                            </div>

                            <div className="mt-6 h-full sm:w-auto md:w-1/3 rounded-lg border bg-white p-10 shadow-md">
        ...
        return (
            <div className="text-center font-bold mt-10">
                {" "}
                No Item in Cart. Please Shopping karen
            </div>
        );
    }
};
